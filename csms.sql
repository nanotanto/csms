...
CREATE TABLE IF NOT EXISTS `elemen` (
  ...
  `penjelasan` varchar(191) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=9 DEFAULT CHARSET=latin1;

-- Dumping data for table csms.elemen: 8 rows
/*!40000 ALTER TABLE `elemen` DISABLE KEYS */;
REPLACE INTO `elemen` (`id`, `bagian`, `penjelasan`) VALUES
	(1, 'Bagian 1:', 'Manajemen, kepemimpinan dan komitmen'),
	(2, 'Bagian 2:', 'Kebijakan HSE dan tujuan strategis'),
	(3, 'Bagian 3:', 'Organisasi, tanggung jawab, sumber daya, standar dan dokumentasi'),
	(4, 'Bagian 4:', 'Manajemen risiko, penanganan bahaya dan dampak'),
	(5, 'Bagian 5:', 'Perencanaan dan prosedur'),
	(6, 'Bagian 6:', 'Pelaksanaan dan pemantauan kinerja'),
	(7, 'Bagian 7:', 'HSE audit dan manajemen HSE-MS'),
	(8, 'Bagian 8:', 'Manajemen HSE-fitur tambahan');
...
-- Dumping data for table csms.evaluasi: 3 rows
/*!40000 ALTER TABLE `evaluasi` DISABLE KEYS */;
REPLACE INTO `evaluasi` (`id`, `perusahaan_id`, `subelemen_id`, `tgl_masuk`, `tgl_target`, `tgl_selesai`, `kesimpulan`, `nilai_id`) VALUES
	(1, 1, 1, '2019-12-18', '2018-12-19 16:00:00', '2018-12-19 16:00:00', 'Semua contoh atau bukti elemen yang diperlukan dar', 0),
	(2, 1, 2, NULL, '2019-12-19 16:00:00', '2019-12-19 16:00:00', 'Semua sub elemen telah terpenuhi dari sisi pemenuh', 0),
	(3, 1, 3, NULL, '2019-12-19 16:00:00', '2019-12-19 16:00:00', 'Kontraktor telah melaksanakan perencanaan K3LL dan', 0);
...
REPLACE INTO `nilai` (`id`, `subelemen_id`, `nilai`, `angka`, `keterangan`) VALUES
	(1, 1, 'A', 0, 'Tidak ada semua'),
	(2, 1, 'B', 3, '1. Ada MWT & Rapat P2K3 \n2. Tapi tidak ada jadwal MWT & Rapat P2K3 \n3. Ada organisasi K3LL yang hanya diisi satu orang'),
	(3, 1, 'C', 6, '1. Ada Organisasi K3LL dan diisi oleh minimal 2 orang \n2. SK Komite HSE (P2K3), \n3. Ada Jadwal MWT & Rapat P2K3, \n4. Minimal dua daftar hadir Rapat P2K3 & dua daftar hadir MWT \n5. Ada media promosi HSE (poster, leaflet, memo, dll) minimal 3 contoh'),
	(4, 1, 'D', 10, 'Seperti C ditambah 1. Ada Jadwal Rapat dan Inspeksi Komite (P2K3), \n2. Ada penilaian kinerja HSE kepada pekerja minimal 3 contoh penilaian \n3. Ada media promosi HSE minimal 3 contoh"'),
	(5, 2, 'A', 0, 'Tidak ada kebijakan K3LL'),
	(6, 2, 'B', 3, 'Kebijakan K3LL ada namun tidak memuat unsur (keselamatan, kesehatan dan lingkungan)'),
	(7, 2, 'C', 6, '1. Kebijakan K3LL ada memuat unsur (keselamatan, kesehatan dan lingkungan) \n2. Target K3LL tertuang dalam Kebijakan K3LL \n3. Sudah sosialisasi melalui media promosi namun tidak ada daftar hadir & MOM'),
	(8, 2, 'D', 10, '1. Kebijakan K3LL ada memuat unsur (keselamatan, kesehatan dan lingkungan) \n2. Target K3LL tertuang dalam Kebijakan K3LL \n3. Sudah sosialisasi melalui media promosi, ada daftar hadir & MOM \n4. Ada review Kebijakan K3LL berkala \n5. Ada Komunikasi K3LL langsung melalui townhall, pelatihan, induction'),
	(9, 3, 'A', 0, 'Tidak ada sasaran strategis :\n- zero accident\n- pengelolaan lingkungan'),
	(10, 3, 'B', 3, '1. Ada sasaran strategis: leading & lagging tapi tidak kuantitatif 2. tidak ada bukti sosialisasi sasaran strategis'),
	(11, 3, 'C', 6, ' 1. Ada sasaran strategis: berupa leading & lagging secara kuantitatif; ada objective (target) K3LL; ada program K3LL \n2. ada bukti sosialisasi sasaran strategis berupa MOM & daftar hadir'),
	(12, 3, 'D', 10, '1. Ada sasaran strategis: berupa leading & lagging secara kuantitatif; ada objective K3LL; ada program K3LL \n2. ada bukti sosialisasi sasaran strategis berupa 2 MOM & 2 daftar hadir \n3. Ada evaluasi program K3LL setahun sekali'),
	(13, 4, 'A', 0, 'Tidak ada organisasi'),
	(14, 4, 'B', 3, '1. Ada Organisasi K3LL dan diisi oleh personil K3LL kerja paruh waktu \n2. personil K3LL status pekerja tetap tersedia namun tidak masuk kedalam struktur Organisasi \n3. personil ditunjuk tidak dibekali dengan kualifikasi (misal: AK3) \n4. Pertemuan K3LL dilaksanakan tidak terjadwal \n5. Pertemuan K3LL dilaksanakan secara rutin namun tidak dilengkapi dengan daftar hadir dan risalah rapat.'),
	(15, 4, 'C', 6, '1. Organisasi K3LL tersedia dan diisi oleh personil K3LL kerja penuh waktu \n2. personil K3LL dilengkapi dengan kualifikasi AK3 3. Ada minimal 3 Pertemuan K3LL dengan daftar hadir dan MOM. \n4. 80% Seluruh personil hadir dalam Rapat K3LL (lihat daftar hadir bandingkan dengan daftar pekerja)'),
	(16, 4, 'D', 10, ' \'1. Organisasi K3LL tersedia dan diisi oleh personil K3LL kerja penuh waktu \n2. personil K3LL dilengkapi dengan kualifikasi AK3 \n3. Ada minimal 3 Pertemuan K3LL dengan daftar hadir dan MOM. 4. 80% Seluruh personil hadir dalam Rapat K3LL (lihat daftar hadir bandingkan dengan dafter pekerja) \n5.Ada 2 daftar hadir & MOM pada Rapat Operasi yang membahas aspek K3LL'),
	(17, 5, 'A', 0, 'Tidak ada kompetensi khusus untuk para manajer/penyelia/staff senior/penasihat K3LL '),
	(18, 5, 'B', 3, '1. Ada Training Matrix aspek K3LL untuk jabatan manajer ke atas tapi tidak ada rencana pelatihan \n2. Pelatihan dilaksanakan namun tidak sesuai dengan kebutuhan dan rencana pelatihan \n3. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir'),
	(19, 5, 'C', 6, '1. Ada Training Matrix aspek K3LL untuk jabatan manajer ke atas \n2. Ada Rencana Training \n3. Pelatihan dilaksanakan namun tidak sesuai dengan kebutuhan dan rencana pelatihan \n4. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir \n5. Tidak ada pelatihan penyegaran'),
	(20, 5, 'D', 10, '1. Ada Training Matrix aspek K3LL untuk jabatan manajer ke atas 2. Ada Rencana Training \n3. Pelatihan dilaksanakan sesuai dengan kebutuhan dan rencana pelatihan \n4. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir \n5. Ada pelatihan penyegaran'),
	(21, 6, 'A', 0, ' A. (Score: 0.00) 1. Tidak ada training K3LL -tidak ada induksi K3LL'),
	(22, 6, 'B', 3, 'B. (Score: 3.00) 1. Induksi dan program training K3LL tersedia namun tidaktertulis \n2. Ada 3 bukti Orientasi/kelas induksi'),
	(23, 6, 'C', 6, ' C. (Score: 6.00) 1. Ada Program tertulis yang mengatur orientasi/induksi dan/atau mentoring untuk pegawai baru atau penugasan baru. 2. Ada Buku saku/materi terkait peraturan perusahaan diberikan kepada karyawan 3. Ada 3 bukti Orientasi/kelas induksi'),
	(24, 6, 'D', 10, ' D. (Score: 10.00) 1. Ada Program tertulis yang mengatur orientasi/induksi dan/atau mentoring untuk pegawai baru atau penugasan baru. 2. Ada Buku saku/materi terkait peraturan perusahaan diberikan kepada karyawan 3. Ada 3 bukti Orientasi/kelas induksi 4. Ada 3 Bukti pelatihan K3LL berupa daftar hadir /sertifikat 5. 3 Bukti tindak lanjuobservasi keselamatan/BBS'),
	(25, 7, 'A', 0, ' A. (Score: 0.00) Tidak ada training matrix, rencana training dan implementasi training'),
	(26, 7, 'B', 3, 'B. (Score: 3.00) 1. Ada Training Matrix aspek K3LL untukjabatan di bawah manajemer tapi tidak ada rencana pelatihan 2. Pelatihan dilaksanakan namun tidak sesuai dengan kebutuhan dan rencana pelatihan 3. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir'),
	(27, 7, 'C', 6, 'C. (Score: 6.00) 1. Ada Training Matrix aspek K3LL untuk jabatan di bawah manajer 2. Ada Rencana Training 3. Pelatihan dilaksanakan namun tidak sesuai dengan kebutuhan dan rencana pelatihan 4. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir 5. Tidak ada pelatihan penyegaran'),
	(28, 7, 'D', 10, ' D. (Score: 10.00) 1. Ada Training Matrix aspek K3LL untuk jabatan di bawah manajer 2. Ada Rencana Training 3. Pelatihan dilaksanakan sesuai dengan kebutuhan dan rencana pelatihan 4. Ada 3 bukti pelatihan (daftar hadir, sertifikat) 2 tahun terakhir 5. Ada pelatihan penyegaran'),
	(29, 8, 'A', 0, 'A. (Score: 0.00) 1. Tidak ada proses/program untuk pengelolaan kontraktor 2. Prosedur tersedia namun tidak divalidasi kembali lebih dari 5 tahun 3 Ada prosedur pengelolaan kontraktor tapi tidak diperjelas)'),
	(30, 8, 'B', 3, 'B. (Score: 3.00) 1. Ada Prosedur namun tidak diimplementasikan 2. Ada Prosedur namun tidak terupdate 3. Ada Prosedur tapi implementasi hanya pada satu tahapan pengelolaan kontraktor (bukan siklus utuh)'),
	(31, 8, 'C', 6, 'C. (Score: 6.00) 1. Prosedur tersedia dan update kurang dari 3 tahun 2. Implementasi pada tahap seleksi dan evaluasi akhir kontrak 3. - Standard perusahaan telah diperjelas, dikomunikasikan dan digunakan pada tahap seleksi saja'),
	(32, 8, 'D', 10, '  D. (Score: 10.00) 1. Prosedur tersedia dan update 2. Implementasi pada tahap seleksi, kontrak berjalan, dan evaluasi akhir kontrak (full Cycle) 3. Standard perusahaan telah diperjelas, dikomunikasikan 4. Pengelolaan kontraktor dilakukan secara full Cycle (minimal ada 1 contoh)'),
	(33, 9, 'A', 0, 'A. (Score: 0.00) Tidak tersedia standard K3LL'),
	(34, 9, 'B', 3, 'B. (Score: 3.00) 1. Prosedur K3LL tersedia namun tidak sesuai dengan standard industri (OGP, OSHA, ANSI, dll) 2. Tersedia Program untuk mendata peraturan K3LL yang berlaku'),
	(35, 9, 'C', 6, ' C. (Score: 6.00) 1. Prosedur K3LL tersedia dan dibuat sesuai dengan strandard industri (OGP, OSHA, ANSI, dll) 2. AdaProgram untuk mendata peraturan dan persyaratan K3LL 3. Ada Evaluasi dari kepatuhan terhadap peraturan dan persyaratan K3LL lainnya dilaksanakan\n '),
	(36, 9, 'D', 10, ' D. (Score: 10.00) 1. Prosedur K3LL tersedia dan dibuat sesuai dengan strandard industri (OGP, OSHA, ANSI, dll) 2. AdaProgram untuk mendata peraturan dan persyaratan K3LL 3. Ada Evaluasi dari kepatuhan terhadap peraturan dan persyaratan K3LL lainnya dilaksanakan 4. Seluruh prosedur K3LL ditinjau secara rutin dan diperbaharui sesuai kebutuhan 5. Peraturan dan persyaratan K3LL dikomunikasikan kepada seluruh karyawan dan dilaksanakan dengan konsisten'),
	(37, 10, 'A', 0, ' A. (Score: 0.00) Tidak ada bukti melakukan penilaian dan pengendalian risiko'),
	(38, 10, 'B', 3, 'B. (Score: 3.00) 1. Prosedur Manajemen Risiko ada tapi tidak ada implementasi 2. Penilaian risiko dilakukan hanya saat operasi di lapangan (JSA)*contoh: JSA, HAZOPS, HAZID, IADL, HIRAC'),
	(39, 10, 'C', 6, '  C. (Score: 6.00) \'1. Ada Prosedur Manajemen Risiko 2. Prosedur Manajemen Risiko mencakup aktifitas pekerjaan dan matriks risiko 3. Ada Implementasi Manajemen Risiko *contoh: JSA, HAZOPS, HAZID, IADL , HIRAC tapi tidak konsisten)\n'),
	(40, 10, 'D', 10, '  D. (Score: 10.00) \'1. Ada Prosedur Manajemen Risiko 2. Prosedur Manajemen Risiko mencakup aktifitas pekerjaan dan matriks risiko 3. Ada Implementasi Manajemen Risiko *contoh: JSA, HAZOPS, HAZID, IADL , HIRAC dilaksanakan secara konsisten'),
	(41, 11, 'A', 0, ' A. (Score: 0.00) Tidak terdapat kebijakan kesehatan yang spesifik dan tidak ada program manajemen bahaya kesehatan.'),
	(42, 11, 'B', 3, 'B. (Score: 3.00) Terdapat program manajemen kesehatan untuk risiko-risiko kesehatan yang signifikan seperti kebisingan, pajanan bahan kimia, malaria, penyalahgunaan obat-batan, penyakit menular melelui darah'),
	(43, 11, 'C', 6, ' C. (Score: 6.00) Terdapat kebijakan kesehatan yang komprehensif dan program-program yang mencakup risiko kesehatan personil yang berhubungan dengan aktifitas perusahaan.\n'),
	(44, 11, 'D', 10, 'D. (Score: 10.00) Korom c; ditambah dengan pemantauan pajanan secara rutin terhadap semua bahaya kesehatan yang mungkin ada dan dilakukan di semua operasi. '),
	(45, 12, 'A', 0, 'A. (Score: 0.00) Tidak ada system prosedur tentang Keselamatan kerja'),
	(46, 12, 'B', 3, 'B. (Score: 3.00) 1.Bahaya keselamatan diidentifikasi tetapi tidak secara komprehensif ada pada HIRADC 2. Pengendalian bahaya terkait ditetapkan namun tidak diimplementasikan'),
	(47, 12, 'C', 6, ' C. (Score: 6.00) 1. Bahaya keselamatan diidentifikasi secara komprehensif 2. Pengendalian bahaya terkait ditetapkan, sudah diimplementasikan namun tidak konsisten\n '),
	(48, 12, 'D', 10, ' D. (Score: 10.00) 1. Bahaya keselamatan diidentifikasi secara komprehensif 2. Pengendalian bahaya terkait ditetapkan, sudah diimplementasikan namun tidak konsisten 3. Ada Prosedur/program manajemen risiko keselamatan seperti prosedur pengangkatan yang aman, perusahaan, bekerja di ketinggian, masuk ruang terbatas,isolasi energi, ijin keselamatan transportasi, dll 4. Ada bukti implementasi program 5. ada Monitoring melalui audit, inspeksi, laporan observasi, dll'),
	(49, 13, 'A', 0, ' A. (Score: 0.00) Tidak ada system prosedur tentang Kegiatan Logistik'),
	(50, 13, 'B', 3, ' B. (Score: 3.00) 1. Bahaya logistik diidentifikasi tetapi tidak komprehensif 2. Pengendalian bahaya terkait ditetapkan namun tidak diimplementasikan'),
	(51, 13, 'C', 6, ' C. (Score: 6.00) 1. Bahaya logistik diidentifikasi secara komprehensif 2. Pengendalian bahaya ditetapkan namun tidak secara konsisten diimplementasikan\n '),
	(52, 13, 'D', 10, ' D. (Score: 10.00) 1. Bahaya logistik diidentifikasi secara komprehensif, diperbarui dan dikomunikasikan pada pekerja 2. Pengendalian bahaya logistik dan pengendaliannya diimplementasikan secara konsisten. 3. Terdapat bukti-bukti pemantauan efektivitas usaha pengendalian melalui: audit, inspeksi, laporan observasi, dll'),
	(53, 14, 'A', 0, 'A. (Score: 0.00) Kontraktor tidak mempunyai metode yang tepat untuk mengelola limbah'),
	(54, 14, 'B', 3, ' B. (Score: 3.00) 1. Bahaya pencemaran lingkungan diidentifikasi tetapi tidak secara komprehensif 2. Pengendalian bahaya terkait ditetapkan tapi tidak diimplementasikan'),
	(55, 14, 'C', 6, 'C. (Score: 6.00) 1. Bahaya lingkungan diidentifikasi secara komprehensif 2. Pengendalian bahayat ditetapkan namun tidak secara konsisten diimplementasikan\n'),
	(56, 14, 'D', 10, 'D. (Score: 10.00) 1. Bahaya pencemaran lingkungan diidentifikasi secara komprehensif, diperbarui dan dikomunikasikan pada pekerja 2. Pengendalian bahaya pencemaran lingkungan dan pengendaliannya diimplementasikan secara konsisten. 3. Ada bukti pemantauan efektivitas usaha pengendalian bahaya (laporan kualitas udara, air, tanah, neraca limbah, dll)'),
	(57, 15, 'A', 0, 'A. (Score: 0.00) Kontraktor tidak mempunyai metode yang tepat untuk mengelola bahaya keamanan'),
	(58, 15, 'B', 3, ' B. (Score: 3.00) 1. Bahaya keamanan diidentifikasi tetapi tidak komprehensif 2. Pengendalian bahaya terkait ditetapkan namun tidak diimplementasikan'),
	(59, 15, 'C', 6, 'C. (Score: 6.00) 1. Bahaya keamanan diidentifikasi secara komprehensif 2. Pengendalian bahaya ditetapkan namun tidak secara konsisten diimplementasikan\n'),
	(60, 15, 'D', 10, 'D. (Score: 10.00) 1. Bahaya keamanan diidentifikasi secara komprehensif, diperbarui dan dikomunikasikan pada pekerja 2. Pengendalian bahaya logistik dan pengendaliannya diimplementasikan secara konsisten. 3. Terdapat bukti-bukti pemantauan efektivitas usaha pengendalian bahaya (audit, inspeksi, laporan, sidak, dll)'),
	(61, 16, 'A', 0, 'A. (Score: 0.00) Kontraktor tidak mempunyai metode yang tepat untuk mengelola bahaya sosial'),
	(62, 16, 'B', 3, ' B. (Score: 3.00) 1. Bahaya sosial diidentifikasi tetapi tidak secara komprehensif seperti prosedur khusus atau HIRADC 2. Pengendalian bahaya terkait ditetapkan'),
	(63, 16, 'C', 6, '  C. (Score: 6.00) 1. Bahaya sosial diidentifikasi secara komprehensif 2. Pengendalian bahaya ditetapkan namun tidak secara konsisten diimplementasikan\n'),
	(64, 16, 'D', 10, '  D. (Score: 10.00) 1. Bahaya sosial diidentifikasi secara komprehensif, diperbarui dan dikomunikasikan pada pekerja 2. Pengendalian bahaya sosial dan pengendaliannya diimplementasikan secara konsisten. 3. Terdapat bukti-bukti pemantauan efektivitas usaha pengendalian bahaya melalui laporan rutin'),
	(65, 17, 'A', 0, 'A. (Score: 0.00) PPE disediakan, tapi tidak ada prosedur untuk menilai kebutuhan individu.'),
	(66, 17, 'B', 3, 'B. (Score: 3.00) 1. Terdapat Prosedur APD, matrix APD, Standard (referensi) APD serta distribusi dan penggantiannya 2. Bukti komunikasi program APD kepada pekerja 3. Ada bukti APD dibagikan sesuai matriks'),
	(67, 17, 'C', 6, 'C. (Score: 6.00) 1.Prosedur APD mencakup pemakaian dan pemeliharaan APD 2.Program APD mencakup pelatihan APD 3. Ada 3 bukti Inspeksi APD dilakukan\n'),
	(68, 17, 'D', 10, 'D. (Score: 10.00) Seperti score 6 ditambahkan: 4. Ketersediaan APD didokumentasikan dan dimonitor dan dipertahankan, ada informasi jumlah cadangan APD '),
	(69, 18, 'A', 0, 'Tidak ada panduan / manual HSE'),
	(70, 18, 'B', 3, ' 1. Manual K3LL, SOP/Instruksi Kerja tersedia namun tidak mencakup semua aktivitas kerja \n2. Program verifikasi yang tidak terstruktur spt kunjungan lapangan, MWT, inspeksi'),
	(71, 18, 'C', 6, '1. SOP/Instruksi kerja yang menyeluruh dan mencakup semua aktivitas kerja termasuk aktivitas risiko tinggi\n2. Program verifikasi yang terstruktur telah diimplementasi namun belum konsisten'),
	(72, 18, 'D', 10, '1. SOP/Instruksi Kerja yang menyeluruh dah dan mencakup semua aktivitas kerja termasuk aktivitas risiko tinggi dan telah divalidasi \n2. Program verifikasi yang terstruktur telah diimplementasi secara konsisten'),
	(73, 19, 'A', 0, 'A. (Score: 0.00) Tidak ada program untuk mengidentifikasi atau mengevaluasi bahaya dan kondisi peralatan'),
	(74, 19, 'B', 3, ' B. (Score: 3.00) 1. Program terbatas mengenai infrastruktur dan peralatan, contoh: hanya perawatan korektif tidak ada program pencegahan, hanya dilakukan pada peralatan milik klien 2. Sertifikasi dilakukan hanya atas permintaan klien'),
	(75, 19, 'C', 6, 'C. (Score: 6.00) 1.Program terencana perawatan untuk pencegahan (PM), termasuk jadwal inspeksi rutin dan implementasi yang konsisten 2. Sertifikasi peralatan secara konsisten dilakukan untuk semua peralatan tidak hanya milik klien\n'),
	(76, 19, 'D', 10, 'D. (Score: 10.00) Semua hal pada score 6 dengan tambahan: Program perawatan dilakukan oleh orang yang kompeten/spesialis dan ada inspeksi rutin oleh manajemen'),
	(77, 20, 'A', 0, ' A. (Score: 0.00) Tidak ada System tentang manajemen Perubahan'),
	(78, 20, 'B', 3, 'B. (Score: 3.00) 1. MOC Hanya berlaku atas permintaan klien atau/dan 2. Hanya mempunyai prosedur MOC saja tanpa implementasi'),
	(79, 20, 'C', 6, 'C. (Score: 6.00) 1. Mempunyai program MOC dan implementasinya sendiri minimal dengan 1 contoh\n'),
	(80, 20, 'D', 10, 'D. (Score: 10.00) 1. Ada prosedur MOC 2. Ada minimal 1 bukti Implementasi 3. Ada evaluasi & tindak lanjut efektivitas sistem MOC'),
	(81, 21, 'A', 0, 'A. (Score: 0.00) Tidak ada prosedur penanggulangan tanggap darurat'),
	(82, 21, 'B', 3, ' B. (Score: 3.00) 1. Prosedur dan dokumen Rencana Tanggap Darurat tersedia yang meliputi kebakaran, evakuasi medis, dan tumpahan bahan kimia 2. Latihan tanggap darurat dilakukan tapi tidak ada program'),
	(83, 21, 'C', 6, 'C. (Score: 6.00) 1. Prosedur Rencana Tanggap Darurat tersedia untuk semua situasi darurat 2. Latihan Tanggap Darurat terencana dan dilakukan secara teratur\n'),
	(84, 21, 'D', 10, 'D. (Score: 10.00) C + Melibatkan fungsi eksternal dan sudah ada evaluasi hasil latihan'),
	(85, 22, 'A', 0, 'A. (Score: 0.00) Tidak ada sistim untuk memantau kinerja HSE (safety & lingkungan)'),
	(86, 22, 'B', 3, ' B. (Score: 3.00) 1. Ada laporan HSE kinerja (safety & lingkungan) bulanan yang sah (diapprove atau ditandatangan manajemen) dengan min 1 contoh laporan'),
	(87, 22, 'C', 6, '\n C. (Score: 6.00) 1. Memenuhi kriteria B 2. Ada Prosedur Pemantauan\n'),
	(88, 22, 'D', 10, 'D. (Score: 10.00) 1. memenuhi kriteria C 2. Ada bukti penghargaan (Jam kerja selamat dari instansi terkait, incident dll) 3. Ada minimal 3 laporan bulanan yang meliputi: - jam kerja selamat - jumlah kejadian'),
	(89, 23, 'A', 0, 'A. (Score: 0.00) 1. Data kinerja HSE dalam 3 tahun terakhir tidak lengkap 2. Tidak ada definisi istilah kinerja HSE'),
	(90, 23, 'B', 3, ' B. (Score: 3.00) 1. Ada Data kinerja HSE dalam 3 tahun terakhir lengkap 2. Ada definisi istilah kinerja HSE 3. Rasio kecelakaan tidak berubah'),
	(91, 23, 'C', 6, 'C. (Score: 6.00) 1. Ada catatan insiden dan kinerja HSE tahun 3 terakhir 2. Ada penurunan insiden kurang dari atau sama dengan 20 % setahun 3. Ada peninjauan kinerja setiap 1 tahun sekali\n'),
	(92, 23, 'D', 10, 'D. (Score: 10.00) 1. Ada catatan insiden dan kinerja HSE tahun 3 terakhir 2. Rasio kecelakaan menurun lebih dari 20% setahun Laporan kinerja harus disyahkan / ditandatangani manajemen. NOTE : JIKA VENDOR MENYATAKAN TIDAK ADA KECELAKAAN NAMUN TIDAK DAPAT MENUNJUKKAN DATA JAM KERJA MAKA DIBERI SCORE A)'),
	(93, 24, 'A', 0, ' A. (Score: 0.00) Kontraktor memiliki pemantauan kinerja salah satu parameter kinerja saja (kesehatan/lingkungan/kemanan)'),
	(94, 24, 'B', 3, 'B. (Score: 3.00) 1.Kontraktor memantau kinerja tiga parameter kinerja saja (kesehatan/lingkungan/kemanan)'),
	(95, 24, 'C', 6, ' C. (Score: 6.00) 1. Kontraktor memantau kinerja empat parameter kinerja saja ( kesehatan/lingkungan/kemanan, keselamatan). 2. Ada laporan bulanan tidak lengkap.\n'),
	(96, 24, 'D', 10, 'D. (Score: 10.00) 1. Kontraktor memantau kinerja empat parameter kinerja saja (kesehatan/lingkungan/keamanan, keselamatan). 2. Ada laporan bulanan lengkap dalam 2 tahun. 3. Ada bukti pembahasan dalam rapat manajemen berupa MOM & daftar hadir.'),
	(97, 25, 'A', 0, 'A. (Score: 0.00) Temuan penyelidikan kecelakaan pada umumnya tidak dikomunikasikan'),
	(98, 25, 'B', 3, 'B. (Score: 3.00) 1. Temuan dikomunikasikan secara terbatas kepada personil kunci / utama melalui memo internal perusahaan atau media yang serupa'),
	(99, 25, 'C', 6, 'C. (Score: 6.00) 1. Temuan dikomunikasikan kepada seluruh karyawan melalui papan pengumuman, email, broadcast, wallpaper, SSD\n'),
	(100, 25, 'D', 10, 'D. (Score: 10.00) 1. Seperti pada C 2. Ada keterangan implikasi terinci untuk keperluan peningkatan kinerja HSE (absensi, MoM, rekomendasi) 3. Ada system; Ada formulir; Ada bukti investigasi'),
	(101, 26, 'A', 0, 'A. (Score: 0.00) Terdapat lebih dari satu kejadian kecelakaan serius (LTI) dalam lima tahun terakhir'),
	(102, 26, 'B', 3, ' B. (Score: 3.00) 1. Satu kejadian kecelakaan serius (LTI) pada lima tahun terakhir (harus tersedia data dalam 5 tahun)'),
	(103, 26, 'C', 6, 'C. (Score: 6.00) 1. Terdapat kejadian MTC dan First Aid saja pada 5 tahun terakhir (harus tersedia data dalam 5 tahun)\n'),
	(104, 26, 'D', 10, 'D. (Score: 10.00) 1. Hanya ada kejadian first aid dalam lima tahun Terakhir(harus tersedia data dalam 5 tahun)'),
	(105, 27, 'A', 0, 'A. (Score: 0.00) Elemen Audit Tidak ada dalam SM HSE'),
	(106, 27, 'B', 3, ' B. (Score: 3.00) 1. Audit dan prosedur tersedia dalam SM HSE, namun tidak ada rincian khusus mengenai penjadwalan dan ruang lingkup'),
	(107, 27, 'C', 6, 'C. (Score: 6.00) 1. Audit dan prosedur tersedia dalam SM HSE 2. ada rincian khusus mengenai penjadwalan dan ruang lingkup\n'),
	(108, 27, 'D', 10, 'D. (Score: 10.00) 1. Poin C + 2. Ada tim Auditor dan auditee 3. Realisasi tindaklanjut temuan Audit'),
	(109, 28, 'A', 0, 'A. (Score: 0.00) Kontraktor tidak memiliki system managemet review'),
	(110, 28, 'B', 3, 'B. (Score: 3.00) 1. Ada prosedur yang mengatur management review ( minimal mengenai proses, jadwal, ruang lingkup dan tugas & tanggungjawab)'),
	(111, 28, 'C', 6, 'C. (Score: 6.00) 1. Ada poin no B 2. Ada 1 buktii management review dengan 1 bukti MOM & Daftar hadir 3. Bukti tindaklanjut temuan audit hasil pembahasan manajemen review.\n'),
	(112, 28, 'D', 10, 'D. (Score: 10.00) 1. Ada Poin no C 2. Ada 2 bukti management review dengan 2 MOM & Daftar hadir 3. Ada bukti tindaklanjut temuan audit 4. Ada bukti tindak lanjutt laporan/hasil tinjauan manajemen dan komunikasinya 5. Ada bukti penelusuran aksi tindaklanjut hasil tinjauan manajemen (action tracking)'),
	(113, 29, 'A', 0, 'A. (Score: 0.00) Tidak memiliki Pedoman Sistem Manajemen'),
	(114, 29, 'B', 3, 'B. (Score: 3.00) 1. Ada sistem manajemen'),
	(115, 29, 'C', 6, 'C. (Score: 6.00) 1. Ada sistem manajemen & menerapkan memiliki Pedoman SM 2. Sedang dalam proses sertifikasi 3. Ada bukti Audit ISO/OHSAS\n'),
	(116, 29, 'D', 10, 'D. (Score: 10.00) 1. Ada bukti sertifikasi secara eksternal untuk satu atau lebih standar internasional seperti ISO 9001 ISO 14001, OHSAS 18OO1 dan masih berlaku.'),
	(117, 30, 'A', 0, 'A. (Score: 0.00) Bukan anggota asosiasi'),
	(118, 30, 'B', 3, 'B. (Score: 3.00) 1. Menjadi anggota satu asosiasi yang tidak menonjolkan HSE (KADIN, IATMI, Asrena Migas, IPA)'),
	(119, 30, 'C', 6, 'C. (Score: 6.00) 1. Kontraktor minimal menjadi anggota satu asosiasi HSE (NFPA, IAKKI, A2K3, dll). Bisa perorangan maupun perusahaan\n \n'),
	(120, 30, 'D', 10, 'D. (Score: 10.00) 1. Kontraktor adalah peserta aktif dari minimal satu asosiasi HSE (Ada bukti 3 kali keikutsertaan kegiatan dalam 2 tahun terakhir. Contoh IAKKI (Ikatan Ahli Keselamatan Kerja Indonesia) score C, IPA (Indonesia Petroleum Association) score B; Bisa perorangan maupun perusahaan'),
	(121, 31, 'A', 0, 'A. (Score: 0.00) Tidak ada'),
	(122, 31, 'B', 3, 'B. (Score: 3.00) 1. Memiliki satu Sertifikat ISO 9001, 14001, OHSAS'),
	(123, 31, 'C', 6, 'C. (Score: 6.00) 1. Memiliki Dua Sertifikat ISO 9001, 14001, OHSAS\n'),
	(124, 31, 'D', 10, 'D. (Score: 10.00) 1. Memiliki Sertifikat ISO 9001, 14001, OHSAS Terintegrasi');
...
REPLACE INTO `perusahaan` (`id`, `nama`, `alamat`, `telepon`) VALUES
	...
	(4, 'PT Adiguna Shipbuilding Engineering', NULL, NULL);
...
REPLACE INTO `subelemen` (`id`, `elemen_id`, `bagian`, `penjelasan`, `keterangan`) VALUES
...
REPLACE INTO `sub_subelemen` (`id`, `subelemen_id`, `no`, `keterangan`) VALUES
